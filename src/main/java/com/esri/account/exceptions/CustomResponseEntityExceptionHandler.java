...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler
    public final ResponseEntity<Object> handleApiKeyException(AccountException ex, WebRequest request){
        AccountExceptionResponse exceptionResponse = new AccountExceptionResponse(ex.getMessage());
